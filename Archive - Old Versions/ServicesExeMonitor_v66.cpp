...
static void darkmode_init_api() {
    ...
    g_dm.SetPreferredAppMode = (DarkModeApi::PFN_SetPreferredAppMode)GetProcAddress(g_dm.ux, MAKEINTRESOURCEA(135));
    g_dm.FlushMenuThemes     = (DarkModeApi::PFN_FlushMenuThemes)    GetProcAddress(g_dm.ux, MAKEINTRESOURCEA(136));
    g_dm.AllowDarkModeForWindow = (DarkModeApi::PFN_AllowDarkModeForWindow)GetProcAddress(g_dm.ux, MAKEINTRESOURCEA(133));
}
