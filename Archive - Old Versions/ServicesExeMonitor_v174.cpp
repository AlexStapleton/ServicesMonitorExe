...
// ----------------------------
static bool prefs_apply(App& self, HWND dlg, HWND e_ui, HWND e_mon, HWND e_cd, HWND e_sw, HWND c_tray, HWND c_close, HWND c_dark, HWND c_flap);
...
if (id == IDC_TOP_QUIT && code == BN_CLICKED) {
    ...
    return 0;
        ...
        if (id == IDC_PREF_APPLY) { prefs_apply(self, dlg, e_ui, e_mon, e_cd, e_sw, c_tray, c_close, c_dark, c_flap); return 0; }
        if (id == IDOK) {
            if (prefs_apply(self, dlg, e_ui, e_mon, e_cd, e_sw, c_tray, c_close, c_dark, c_flap)) DestroyWindow(dlg);
            return 0;
        }
        return 0;
    }
