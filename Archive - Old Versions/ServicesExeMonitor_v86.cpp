...
static void theme_menu_make_owner_draw(HMENU menu) {
...
if (id == IDC_TOP_EXIT && code == BN_CLICKED) {
    ...
    case WM_SIZE: {
        ...
        if (hCancel) SetWindowPos(hCancel, NULL, xCancel, yBtn, btnW, topBtnH, SWP_NOZORDER | SWP_NOACTIVATE);
        if (hApply) SetWindowPos(hApply, NULL, xApply, yBtn, btnW, topBtnH, SWP_NOZORDER | SWP_NOACTIVATE);
        if (hOK) SetWindowPos(hOK, NULL, xOK, yBtn, btnW, topBtnH, SWP_NOZORDER | SWP_NOACTIVATE);
        return 0;
    }
