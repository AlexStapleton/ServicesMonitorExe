...
self.btn_quit_to_tray = CreateWindowExW(0, L"BUTTON", L"Exit to tray",
    WS_CHILD | WS_VISIBLE | WS_TABSTOP,
...
self.activity_panel_w = rightW;
    ...
    SetWindowPos(self.btn_quit, NULL, pad + btnW + S(8), yTop, btnW, topBtnH, SWP_NOZORDER);
SetWindowPos(self.btn_exit_to_tray, NULL, pad + btnW + S(8) + btnW + S(8), yTop, btnW + S(40), topBtnH, SWP_NOZORDER);
