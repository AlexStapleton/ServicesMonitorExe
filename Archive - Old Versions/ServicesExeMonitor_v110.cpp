...
static void lv_update_row_existing_with(App& self, HWND lv, int kind, Item* it, const wchar_t* status_raw, time_t wall_ts);
...
// --- brace fix: close dangling scopes (auto-added) ---
}
}
}