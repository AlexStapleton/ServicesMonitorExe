...
[[maybe_unused]] static void theme_menu_make_owner_draw(HMENU menu) {
    theme_menu_set_owner_draw(menu, true);
}
...
[[maybe_unused]] static void theme_apply_everywhere(App& self) {
    theme_compute(self);
