...
static LRESULT CALLBACK HelpWndProc(HWND dlg, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE: {
        ...
        const wchar_t* help =
            L"Global
"
            L"  Ctrl+F    Focus search (Services/EXEs)
"
            L"  Ctrl+1    Switch to Services tab
"
            L"  Ctrl+2    Switch to EXEs tab
"
            L"  Ctrl+S    Save config now
"
            L"  Ctrl+L    Focus the main list
"
            L"  F5        Refresh UI (force resync)
"
            L"
"
            L"Search
"
            L"  Esc       Clear search (works from search box or list)
"
            L"
"
            L"Service / EXE table
...
"
            L"  Del       Remove selected
"
            L"  Space     Toggle Auto-stop
"
            L"  Ctrl+C    Copy selected name
";
