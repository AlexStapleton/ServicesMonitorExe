...
static LRESULT CALLBACK HotkeysWndProc(HWND dlg, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE: {
        ...
        HWND lv = CreateWindowExW(WS_EX_CLIENTEDGE, WC_LISTVIEWW, L"",
            ...
            0, 0, 100, 100, dlg, (HMENU)101, self.hinst, NULL);

        ListView_SetExtendedListViewStyle(lv, LVS_EX_FULLROWSELECT | LVS_EX_DOUBLEBUFFER);

        LVCOLUMNW c0 = {0}; c0.mask = LVCF_TEXT | LVCF_WIDTH; c0.pszText = (LPWSTR)L"Shortcut"; c0.cx = 140;
        LVCOLUMNW c1 = {0}; c1.mask = LVCF_TEXT | LVCF_WIDTH; c1.pszText = (LPWSTR)L"Action";   c1.cx = 520;
        ...
        CreateWindowExW(0, L"BUTTON", L"Copy",
            ...
            0, 0, 80, 28, dlg, (HMENU)IDC_DIAG_COPY, self.hinst, NULL);

        CreateWindowExW(0, L"BUTTON", L"Close",
            WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
            0, 0, 80, 28, dlg, (HMENU)IDCANCEL, self.hinst, NULL);
    ...
    case WM_SIZE: {
        ...
        HWND lv = GetDlgItem(dlg, 101);
        HWND b_copy = GetDlgItem(dlg, IDC_DIAG_COPY);
